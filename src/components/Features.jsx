    ...
    >
      <div className="mx-auto grid max-w-7xl gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
        {features.map(({ icon: Icon, title, description }) => (
          <article
            key={title}
            className="scroll-reveal-item card-shadow rounded-3xl border border-beige/60 bg-white px-6 py-8 text-center transition duration-300 hover:-translate-y-1 hover:border-tan/80 hover:card-shadow-hover lg:text-left"
          >
